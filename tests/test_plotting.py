...
def test_main():
    """Primitive testing for matplotlib figure generation"""
    try:
        ...
        assert False, "Exception was raised when plotting BMP280 rho"
    else:
        assert True
    ...
    try:
        ...
        assert False, "Exception was raised when plotting MPXV7002DP q pressure"
    else:
        assert True
    ...
    try:
        ...
        assert False, "Exception was raised when plotting MPXV7002DP eqairspeed"
    else:
        assert True
    return
